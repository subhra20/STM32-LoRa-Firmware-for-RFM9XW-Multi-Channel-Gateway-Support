...
LoRa_i newLoRa_i(void);
void LoRa_reset_i(LoRa_i* _LoRa);
void LoRa_readReg_i(LoRa_i* _LoRa, uint8_t* address, uint16_t r_length, uint8_t* output, uint16_t w_length);
void LoRa_writeReg_i(LoRa_i* _LoRa, uint8_t* address, uint16_t r_length, uint8_t* values, uint16_t w_length);
...
void LoRa_setSpreadingFactor_i(LoRa_i* _LoRa, int SP);
...
//void LoRa_receive_IT(LoRa_i* _LoRa, uint8_t* data, uint8_t length);
