...
typedef struct LoRa_setting_iii{
...
LoRa_iii newLoRa_iii(void);
void LoRa_reset_iii(LoRa_iii* _LoRa);
void LoRa_readReg_iii(LoRa_iii* _LoRa, uint8_t* address, uint16_t r_length, uint8_t* output, uint16_t w_length);
void LoRa_writeReg_iii(LoRa_iii* _LoRa, uint8_t* address, uint16_t r_length, uint8_t* values, uint16_t w_length);
...
void LoRa_setSpreadingFactor_iii(LoRa_iii* _LoRa, int SP);
...
//void LoRa_receive_IT(LoRa_iii* _LoRa, uint8_t* data, uint8_t length);
int LoRa_getRSSI_iii(LoRa_iii* _LoRa);

uint16_t LoRa_init_iii(LoRa_iii* _LoRa);

#endif /* INC_LORA_III_H_ */
